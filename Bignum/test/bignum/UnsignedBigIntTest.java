...
public class UnsignedBigIntTest {
    ...
    public void testDivide() {
        ...
        assertEquals(b.divide(a), 
                new UnsignedBigInt("1000000010000000100000001000000010000")
                .multiply(new UnsignedBigInt("12341234")));
    }
    ...
    public void testMultiply_karatsuba() {
        ...
        assertEquals(c.multiply(c), "");
    }
